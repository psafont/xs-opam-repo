...
Name: xs-opam-repo
Version: %{_version}
Release: %{?xsrel}.1.0.neonov.3%{?dist}
...
# take not of packages that need to be installed. They have to be installable with already installed package versions, in particular with the current OCaml version.
